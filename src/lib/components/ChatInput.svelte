...
<div class="flex items-end gap-2">
	...
	<textarea
		...
		class="flex-1 min-h-[44px] max-h-30 resize-none border-0 bg-transparent p-0 text-sm text-[#e2e8f0] placeholder-[#475569] focus:outline-none focus:ring-0 disabled:opacity-50"
	></textarea>
	<button
		onclick={handleSend}
